...
The best practice for finding materials that are missing in transit is to run this report once a week and then:

1. Search for the items at your library - checking in any items found
2. E-mailing the other libraries involved in the transfer if the items are not found and asking them to do a shelf check
3. Contacting the courier coordinator at NEKLS following the courier guidelines when necessary
4. Marking un-found items as "Missing (unable to locate on shelf)" after all attempts by all libraries and the courier have been made
...
See :doc:`/pages/reports/finding` if you don't know how to find a report by number.
