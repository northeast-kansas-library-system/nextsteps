...
Report 003633 // GHW - Statistics - Daily overdue count for prevous calendar month
==================================================================================

Report information: 3633
------------------------
        ...
        FROM
          (SELECT
            ...
            FROM
              old_issues
            WHERE
              old_issues.date_due <= AddDate(Last_Day(SubDate(Now(), INTERVAL 2 Month)), 1) + INTERVAL 26 DAY AND old_issues.returndate > AddDate(Last_Day(SubDate(Now(), INTERVAL 2 Month)), 1) + INTERVAL 26 DAY
            GROUP BY
