...
Report 003355 // D2 Circulation by borrower details - Unique borrowers
======================================================================

Report information: 3355
------------------------
...
.. code-block:: sql
  :linenos:
    ...
    SELECT 
      ...
      Date_Format(AddDate(Last_Day(SubDate(Now(), INTERVAL 2 MONTH)), 1) + INTERVAL 23 DAY, "%W") A
