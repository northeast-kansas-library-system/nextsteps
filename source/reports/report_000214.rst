...
Report 000214 // GHW - Items with important fields that are blank or have problematic values
============================================================================================

Report information: 214
-----------------------
...
Modified on: 2023-03-22 09:52:52

Cache expiry in seconds: 500
  ...
  <div style="border: 1px solid black; padding: 25px;">
    ...
    <div id="reportinfo" class="noprint reportInfo"> 
      ...
      <div id="reportInfoLinks"> 
        ...
        <p id="sql_to_new_window"> 
          <a href="/cgi-bin/koha/reports/guided_reports.pl?reports= XX PUT REPORTNUMBER HERE and remove XXs and Spaces XX &phase=Run%20this%20report" 
             target="_blank">Click here to run in a new window 
          </a> 
        </p> 
     
        <p id="sql_quick_down"> 
          <a href="/cgi-bin/koha/reports/guided_reports.pl?reports=1&phase=Export&format=csv&report_id= XX PUT REPORTNUMBER HERE and remove XXs and Spaces XX"> 
