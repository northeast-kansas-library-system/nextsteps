...
Due to the advances in magnetic computer data storage in the late 1960s, the Library of Congress set up the Marc Pilot Project in the late 1960s.  Their goal was two-fold.  They wanted to replace their card catalog with a computer based catalog system and they wanted to make it easier to print cataloging cards for the users of their cataloging distribution service.
